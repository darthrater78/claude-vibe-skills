# Script collection Workflow Template

Loaded on demand by the dev-skills skill, **only when project environment
detection matches Script collection** (`WORKFLOW_REFERENCE.md`, "Workflow selection
procedure", Step 1). A project that is not Script collection never needs this file.
